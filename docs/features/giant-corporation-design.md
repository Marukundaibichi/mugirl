...
- 日期：2026-09-16。
- 人员交易与毛制家具收购规则更新：2026-09-24；首版运行证据仍按原日期保留，新规则的实际验证见[首版验证记录新增章节](giant-corporation-v1-validation.md)。
- 适用版本：RimWorld 1.6。
...
| 高价收购雪牛娘奶、毛、制品及毛制家具 | 独立产品收购页，按实际货物估值，支持原料、材料制品、记录了原料的食品和已卸载打包的毛制家具 |
...
| 每周展出数名雪牛娘，可作为奴隶或殖民者购入 | 保存具体 Pawn 的周展览，展示能力、状态和成套服装；殖民者档加价 50%，奴隶加入依赖 Ideology |
...
永久提供收购需求。范围包括雪牛娘奶、雪牛娘毛、明确的雪牛娘奶制食品、使用雪牛娘毛作为材料制作的货物，以及已卸载打包的雪牛娘毛制家具。

识别规则：

1. 直接识别本模组的奶、毛和专属奶制品 Def。
2. 对材料型制品检查实际 `Stuff`，而非只看服装或物品名称。打包家具必须是 `MinifiedThing`，其内部为建造分类 `Furniture` 的 `Building`，且内部实际 `Stuff` 为雪牛娘毛；不凭包装物标签或可能使用的建材认定。
3. 对混合配方食品检查实际保存的原料信息；未记录原料、无法确认使用了雪牛娘产品的通用品，不凭配方可能性给予溢价。
4. 第三方明确制品可通过扩展白名单加入，不以名称包含“奶”或“牛”作为通用识别标准。

报价按物品实际市场价值计算，反映品质、耐久和材料。原奶与原毛为市场价值的 1.6 倍；可确认的制品及合格打包家具为实际市场价值的 1.3 倍。已安装家具、蓝图和施工框架不收购：殖民地须先卸载家具，确保打包物位于已供电贸易信标范围；远行队须将其放入物品库存。禁止变质食品、尸体污染服装及其他原版不宜出售的对象。
...
2026-09-24 起，人员买卖共用实际市场价值 ×1.5 的基础报价。手续费与运费各为基础报价的 5%，购买加收、出售扣除；这让同一报价来源清楚可查，也让往返交易有实际成本。殖民者档再加基础报价的 50%，对应直接获得自由殖民者的便利。每项金额分别向上取整，避免低价 Pawn 因取整丢失费用。例如实际市场价值 100 时，基础报价 150、两项费用各 8：奴隶购入 166、殖民者购入 241、出售实收 134 白银。市值与穿戴装备可能随时间变化，成交前始终以当前 Pawn 和确认页报价为准。
...
- 买卖使用同一个基础报价：该 Pawn 实际市场价值 ×1.5 后向上取整。出售时扣除手续费与运费后支付净款；两项费用各按基础报价 ×5% 向上取整，实收至少 1 白银。交易前明确列出基础报价、两项费用和实收金额。
...
- 新生成的展览人员使用独立的 `Mugirl_CorporateShowcase` PawnKind，不再沿用传统雪牛娘奴隶的生成造型。每人随机选择一整套预先搭好的主题服装，保留原配色；上下装、内衣和配饰按固定清单一起生成，不独立随机拼件，也不统一成单件 `Mugirl_Uniform`。展销池排除明显用于作战的盔甲、战斗服及战术装备；保留警察角色装束。实际穿戴的整套服装计入 Pawn 市值，再参与共同基础报价，档案展示同一名实际 Pawn。
- 当前共十二套：原有修女经典款/清廉款（对应修女服、头纱、眼罩）、警察普通胸衣款/拉链胸衣款（对应胸衣、系带内裤、上衣、短裤、长筒靴、警察帽）、兔女郎（上衣、连裤袜、兔耳头饰）、高叉毛衣（毛衣、高跟鞋、口罩、手袋），另加入 OL（OL 套装、墨镜、链条手袋）、婚纱（婚纱、白金色面纱）、旗袍（旗袍、链条手袋）、仙女服（仙女服、白金色面纱）、霜蓝仙子服（霜蓝仙子服、白金色面纱）和休闲套（白色条纹衬衫「惑光半透」、牛仔长裤「蓝境远行」）。OL、婚纱与旗袍的贴图已包含上下身造型，不再叠穿其他裤袜或靴子；两款仙女服保留轻薄袖摆，不加入黑色皮靴或吊带袜；休闲套沿用牛仔裤自带鞋饰，不再叠穿袜靴。配饰可按风格复用，但每套组合固定。
- 奴隶档使用与收购相同的基础报价，加收按基础报价各 5% 向上取整的手续费与运费。殖民者档另加基础报价 ×50% 向上取整的身份加价，手续费与运费仍按共同基础报价计算。两档在确认页分别显示基础报价、各项加价及实际付款。
- 人员页只在顶部保留“本周展览 / 巨企收购”切换；购买按钮右侧用下拉栏选择“购买为奴隶”或“购买为殖民者”，报价与按钮随选择同步更新。未启用 Ideology 时，下拉栏只有“购买为殖民者”。已付款待领取的人员保留签约身份，不再允许切换。
- 购买后按所选档位作为奴隶或自由殖民者加入玩家派系；接收地点为交易地图或当前远行队。自由殖民者档不要求 Ideology，奴隶档仍受该 DLC 与意识形态交易规则约束。
- 同一名 Pawn 的人员交易仅首次非免费成交增加巨企客户等级所用的累计交易额，按该笔实际付款或实收计算；巨企派系的原版交易同样参与去重。重复买入、卖出该 Pawn 不再增加交易额，以免通过往返交易刷等级；付款、收款本身仍按当前报价发生。每周免费名额可用于任一购买身份，免除整笔费用，也不会占用该 Pawn 的首次计额机会。
- 未售人员轮换时通过正常世界 Pawn 生命周期处理，不遗留重复世界记录，不直接删除与玩家已有关系的人物。

### 6.3 DLC 与兼容

奴隶档使用 Ideology 的奴隶系统；未启用 Ideology 时只禁用奴隶档，殖民者档仍可购买。出售使用核心可用的原版交易后果，Ideology 专属事件和规则加条件检查。

本轮人员展览与收购限定成年人，年龄规则独立于既有模组事件，不顺手修改现有事件的生成年龄。

旧档已生成的本周人员继续保留同一 Pawn；未付款的旧混搭或单件制服在首次读档时换成上述完整套装，并按换装后的市值更新展示基础报价；已有完整套装不重抽、不换件。已付款的待交付人员保留签约时的衣装、原实付金额和原身份，领取时不重复扣款。新身份选择与交付阶段随订单保存。已计额人员 ID 列表在旧档缺失时默认为空，从新版完成的首笔非免费交易开始去重，不推算旧版历史交易。
...
| 同时未领取订单 | 5 单 |
| 每周人员展览 | 4 名成年雪牛娘 |
| 人员共同基础报价 | `Ceil(Pawn 实际市场价值 ×1.5)`；奴隶购入按该基础报价，殖民者另加 `Ceil(基础报价 ×0.5)` |
| 人员交易费用 | 手续费、运费各 `Ceil(基础报价 ×0.05)`；购买加收，出售扣除且实收至少 1 白银 |
| 额外出售记忆 | -8，8 日，不无限叠加 |
| 贷款本金范围 | 500–30,000 |
| 最大贷款与抵押估值之比 | 70% |
| 正常/逾期日单利 | 剩余本金的 2% / 3% |
...
| 人员展览 | Pawn 所有权/引用、展示基础报价、已付金额及所选身份、售出状态、所属周期 |
| 人员交易额 | 已计额 Pawn 的稳定身份标记；同一人再次买卖不重复累计，旧档从更新后的首次交易开始记录 |
...
| 收购 | 原奶、原毛、毛料制品、实际含奶食品、无法确认原料食品、已卸载且内部实际为雪牛娘毛材质的打包家具、非毛制打包家具、已安装家具/蓝图/施工框架排除、不同品质耐久报价 |
| 交易一致性 | 重复点击、部分堆栈、恰好够钱、付款后交付异常、目录 Def 缺失、收款退款只发生一次 |
| 订单 | 延时到货、取消规则、无接收地图、远行队解散、超重提示、异常订单退款 |
| 人员 | 奴隶/殖民者身份及报价、手续费和运费、非战斗主题成套服装及旧衣装迁移、原版交易记忆/意识形态、额外记忆、亲友关系、不可出售访客、未售 Pawn 清理、同一人往返交易只计一次交易额 |
| DLC | 无 Ideology 可购殖民者、禁用奴隶档；全 DLC 人员交易；缺可选 DLC 不出现红字任务 |
