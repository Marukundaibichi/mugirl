...
- 原图：`TMP/PerformanceOptimization-20260907/OriginalTextures/`，保留原有相对路径，共 358 张。
- 原 DLL：`TMP/PerformanceOptimization-20260907/OriginalAssemblies/MugirlRace.dll`。
- 纹理清单：`TMP/PerformanceOptimization-20260907/textures.json`。
- FA 移动清单：`TMP/PerformanceOptimization-20260907/fa-move-hashes.json`。
- 分层对比：`TMP/PerformanceOptimization-20260907/texture-comparison.png`。
- 正面合成对比：`TMP/PerformanceOptimization-20260907/face-layer-comparison.png`。
- 完整验证日志：`TMP/PerformanceOptimization-20260907/static-validation.log`。
