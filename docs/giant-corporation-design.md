...
- 普通订购价 2.2 倍市场价值，稀有货物 2.8 倍；材料、品质和数量进入最终报价。
- 普通货物备货 3–5 日，稀有货物 7–12 日；签约时固定具体到货时刻。
...
进入任务地图后，先触发研究团队联络。对话完成前双方处于可交谈状态，目标不会因为临时用了敌对派系而在对白前主动开火。
