...
namespace MooGirl
{
    ...
    internal static class MooGirlPatchCatalog
    {
        ...
        private static readonly List<MooGirlPatchInfo> patchInfos = new List<MooGirlPatchInfo>
        {
            ...
            Info(moduleName: "AlienRace", patchClassName: "Patch_AlienPawnRenderNode_Swaddle_GraphicFor", targetTypeName: "AlienRace.AlienPawnRenderNode_Swaddle", targetMethodName: "GraphicFor", patchKind: "Manual Prefix", maySkipOriginal: true, compatibilityRisk: MooGirlPatchRiskLevel.High, failureBehavior: "HAR swaddle rendering falls back to the AlienRace result.", registryNameKey: "MooGirl.PatchRegistry.AlienRaceSwaddleGraphicFor"),
            ...
            Info(moduleName: "Restraints", patchClassName: "Patch_PawnStoryTracker_SkinColor", targetTypeName: "RimWorld.Pawn_StoryTracker", targetMethodName: "SkinColor", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MooGirlPatchRiskLevel.Medium, failureBehavior: "MooGirl skin color falls back to the base story tracker result."),
