...
namespace Mugirl
{
    ...
    internal static class MugirlPatchCatalog
    {
        ...
        {
            Info(moduleName: "SaveCompatibility", patchClassName: "CorporateValidationSaveMigration", targetTypeName: "Verse.Game", targetMethodName: "ExposeSmallComponents", patchKind: "Prefix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Low, failureBehavior: "Old saves containing the two obsolete corporate validation drivers log missing-class errors; all normal game components use unchanged loading."),
            Info(moduleName: "SaveCompatibility", patchClassName: "NeuralShoulderSaveMigration", targetTypeName: "Verse.Game", targetMethodName: "ExposeSmallComponents", patchKind: "Prefix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "旧肩甲及其制作订单可能产生缺失 Def 错误；其他存档数据不受影响。"),
            ...
            Info(moduleName: "Corporate", patchClassName: "Harmony_CorporateTradeTurnover", targetTypeName: "RimWorld.TradeDeal", targetMethodName: "TryExecute", patchKind: "Prefix/Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Low, failureBehavior: "Vanilla corporate trades do not contribute to client service progress."),
            Info(moduleName: "Corporate", patchClassName: "Harmony_CorporateUniforms", targetTypeName: "Verse.PawnGenerator", targetMethodName: "GeneratePawn(PawnGenerationRequest)", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Low, failureBehavior: "Ideologies that suppress apparel can omit corporate uniforms."),
            ...
            Info(moduleName: "Corporate", patchClassName: "Harmony_CorporateDiehard_NoPanicFlee", targetTypeName: "RimWorld.MentalStateHandler", targetMethodName: "TryStartMentalState", patchKind: "Prefix", maySkipOriginal: true, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "Diehard support troopers can start the base panic-flee mental state."),
            Info(moduleName: "Corporate", patchClassName: "Harmony_CorporateDiehard_FriendlyFireGoodwill", targetTypeName: "RimWorld.Faction", targetMethodName: "TryAffectGoodwillWith", patchKind: "Prefix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "Friendly-fire goodwill penalties from hitting diehard support troopers are not discounted."),
            ...
            Info(moduleName: "Appearance", patchClassName: "Harmony_PawnHairColors_HasGreyHair_Mugirl", targetTypeName: "RimWorld.PawnHairColors", targetMethodName: "HasGreyHair(Pawn, int)", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Low, failureBehavior: "Newly generated older Mugirls can receive HAR's muted old-hair color instead of keeping their original hair color."),
            Info(moduleName: "Appearance", patchClassName: "Harmony_LovinBodyAccessory", targetTypeName: "RimWorld.JobDriver_Lovin", targetMethodName: "GenerateRandomMinTicksToNextLovin", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Low, failureBehavior: "Lovin completes normally, but no temporary bite or handprint body mark is added."),
            Info(moduleName: "Appearance", patchClassName: "Harmony_ExtraOutline_Body", targetTypeName: "Verse.PawnRenderTree", targetMethodName: "Draw", patchKind: "Prefix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "Optional Mugirl body/apparel outlines are absent; original drawing is preserved."),
            ...
            Info(moduleName: "AdvancedArmor", patchClassName: "Harmony_NeuralArmorBulletStagger", targetTypeName: "RimWorld.StaggerHandler", targetMethodName: "Notify_BulletImpact", patchKind: "Prefix", maySkipOriginal: true, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "Neural combat armor wearers receive normal bullet stagger."),
            Info(moduleName: "AdvancedArmor", patchClassName: "Harmony_NeuralHelmetPsychicDrone", targetTypeName: "RimWorld.ThoughtWorker_PsychicDrone", targetMethodName: "CurrentStateInternal", patchKind: "Prefix", maySkipOriginal: true, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "The neural amplifier helmet no longer suppresses psychic-drone thoughts."),
            Info(moduleName: "AdvancedArmor", patchClassName: "Harmony_NeuralHelmetDarknessAccuracy", targetTypeName: "Verse.ShotReport", targetMethodName: "HitReportFor", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "The neural amplifier helmet no longer cancels darkness accuracy offsets."),
            Info(moduleName: "AdvancedArmor", patchClassName: "Harmony_NeuralHelmetUnnaturalDarkness", targetTypeName: "RimWorld.GameCondition_UnnaturalDarkness", targetMethodName: "AffectedByDarkness", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "The neural amplifier helmet no longer protects against unnatural darkness."),
            Info(moduleName: "Weapons", patchClassName: "Harmony_MugirlRaceRestrictedWeapons", targetTypeName: "RimWorld.EquipmentUtility", targetMethodName: "CanEquip(Thing, Pawn, out string, bool)", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "Mugirl-only weapons can be equipped by other races."),
            Info(moduleName: "Lances", patchClassName: "Harmony_LanceGizmos", targetTypeName: "Verse.Pawn_EquipmentTracker", targetMethodName: "GetGizmos", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Low, failureBehavior: "骑枪冲锋按钮缺失；原有装备指令不受影响。"),
            ...
            Info(moduleName: "Incidents", patchClassName: "Harmony_FarmAnimalsWanderIn_TryFindRandomPawnKind_NullRaceGuard", targetTypeName: "RimWorld.IncidentWorker_FarmAnimalsWanderIn", targetMethodName: "TryFindRandomPawnKind", patchKind: "Finalizer", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "Null-race PawnKindDefs throw inside vanilla farm-animal incident filtering again."),
            Info(moduleName: "Incidents", patchClassName: "Harmony_StockGenerator_Animals_PawnKindAllowed_NullRaceGuard", targetTypeName: "RimWorld.StockGenerator_Animals", targetMethodName: "PawnKindAllowed", patchKind: "Finalizer", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "Null-race PawnKindDefs throw inside animal stock generation and can wipe settlement stock."),
            ...
            Info(moduleName: "Milk", patchClassName: "Harmony_MugirlMilkingAnimation_DrawFacing", targetTypeName: "Verse.PawnRenderer", targetMethodName: "GetDrawParms", patchKind: "Prefix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "Paired milking facing falls back to pawn rotation and may be overridden by job posture."),
            ...
            Info(moduleName: "Misc", patchClassName: "Harmony_MugirlPregnancyMood_New", targetTypeName: "Verse.HediffComp_GiveRandomSituationalThought", targetMethodName: "CompPostMake", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Low, failureBehavior: "雪牛娘新生成的怀孕心情恢复原版随机结果，其他种族不受影响。"),
            Info(moduleName: "Misc", patchClassName: "Harmony_MugirlPregnancyMood_Load", targetTypeName: "Verse.HediffComp_GiveRandomSituationalThought", targetMethodName: "CompExposeData", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Low, failureBehavior: "旧存档中雪牛娘已有的负面怀孕心情保留到自然消失，其他存档数据不受影响。"),
            ...
            Info(moduleName: "Misc", patchClassName: "Harmony_MugirlFoodPolicyGrass_NewGame", targetTypeName: "RimWorld.FoodRestrictionDatabase", targetMethodName: "GenerateStartingFoodRestrictions", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Low, failureBehavior: "New games do not receive the grass food policy preset for Mugirl grazing."),
            Info(moduleName: "Misc", patchClassName: "Harmony_MugirlFoodPolicyGrass_ExistingSave", targetTypeName: "RimWorld.FoodRestrictionDatabase", targetMethodName: "ExposeData", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Low, failureBehavior: "Existing saves do not receive the grass food policy preset for Mugirl grazing."),
            ...
            Info(moduleName: "Lances", patchClassName: "Harmony_LanceCharge_DrawCarriedWeapon", targetTypeName: "Verse.PawnRenderUtility", targetMethodName: "DrawCarriedWeapon", patchKind: "Prefix", maySkipOriginal: true, compatibilityRisk: MugirlPatchRiskLevel.High, failureBehavior: "Lances use the base diagonal carried-weapon pose during direct charge flight."),
            Info(moduleName: "Lances", patchClassName: "Harmony_LanceCharge_BlurRecovery", targetTypeName: "Verse.Pawn", targetMethodName: "DynamicDrawPhaseAt", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Low, failureBehavior: "Landing motion blur is omitted; pawn drawing and charge gameplay remain unchanged."),
            ...
            Info(moduleName: "Roping", patchClassName: "Patch_FoodUtility_IsAcceptablePreyFor_Mugirl", targetTypeName: "RimWorld.FoodUtility", targetMethodName: "IsAcceptablePreyFor", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Medium, failureBehavior: "Wild or starving Mugirls can again select humanlike pawns as live prey."),
