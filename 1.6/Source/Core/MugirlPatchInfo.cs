...
namespace Mugirl
{
    ...
    internal static class MugirlPatchCatalog
    {
        ...
        private static readonly List<MugirlPatchInfo> patchInfos = new List<MugirlPatchInfo>
        {
            ...
            Info(moduleName: "WeaponWheel", patchClassName: "Harmony_WeaponWheel_BurstCompleted", targetTypeName: "Verse.Verb", targetMethodName: "TryCastNextBurstShot", patchKind: "Postfix", maySkipOriginal: false, compatibilityRisk: MugirlPatchRiskLevel.Critical, failureBehavior: "Full-firepower chains do not advance after a weapon finishes its burst."),
            ...
            Info(moduleName: "WeaponWheel", patchClassName: "Harmony_WeaponWheel_DrawCarriedWeapon", targetTypeName: "Verse.PawnRenderUtility", targetMethodName: "DrawCarriedWeapon", patchKind: "Prefix", maySkipOriginal: true, compatibilityRisk: MugirlPatchRiskLevel.High, failureBehavior: "The base carried weapon may overlap the custom equip animation."),
