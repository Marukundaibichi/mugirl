...
namespace Mugirl
{
    public static class MugirlNurtureUtility
    {
        ...
        // StaticCacheLifecycle: 每局游戏的 Def 查询缓存；由 MugirlStoryState 在初始化、新建和读档时重置。
        ...
        public static HediffDef MotherlyNurtureDef => motherlyNurtureDef ?? (motherlyNurtureDef = DefDatabase<HediffDef>.GetNamedSilentFail("Mugirl_MotherlyNurture"));
        public static HediffDef NurtureAfterglowDef => nurtureAfterglowDef ?? (nurtureAfterglowDef = DefDatabase<HediffDef>.GetNamedSilentFail("Mugirl_NurtureAfterglow"));
        public static TraitDef NurturedTraitDef => nurturedTraitDef ?? (nurturedTraitDef = DefDatabase<TraitDef>.GetNamedSilentFail("Mugirl_NurturedByMugirl"));
        ...
        public static void AddNurtureProgress(Pawn pawn, float amount, Pawn feeder = null)
        {
            ...
            hediff.TryGetComp<HediffComp_MugirlNurtureProgress>()?.TryComplete(feeder);
        }
        ...
        public static void CompleteNurture(Pawn pawn, Hediff hediff, Pawn feeder = null)
        {
            ...
            Messages.Message("Mugirl.Nurture.Completed".Translate(pawn.Named("PAWN")), pawn, MessageTypeDefOf.PositiveEvent);
        }
