...
namespace Mugirl
{
    ...
    public class IncidentWorker_Mugirl_WildManWandersIn : IncidentWorker_WildManWandersIn
    {
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            string value = pawn.DevelopmentalStage.Child() ? "Mugirl.FeralChild".Translate().ToString() : pawn.KindLabel;
            TaggedString value2 = pawn.DevelopmentalStage.Child() ? "Mugirl.Child".Translate() : "Mugirl.Person".Translate();
